...
async function main() {
  ...
  try {
    ...
    const cerealesGrains = [
      { name: 'Riz Local', description: 'Riz cultive localement au Cameroun', unit: 'kg', price: 2.50, imageUrl: '' },
      { name: 'Mais Blanc', description: 'Mais blanc frais du marche local', unit: 'kg', price: 1.80, imageUrl: '' },
      { name: 'Mais Jaune', description: 'Mais jaune pour la consommation', unit: 'kg', price: 1.90, imageUrl: '' },
      { name: 'Mil', description: 'Mil traditionnel camerounais', unit: 'kg', price: 2.20, imageUrl: '' },
      { name: 'Sorgho', description: 'Sorgho rouge local', unit: 'kg', price: 2.00, imageUrl: '' },
      { name: 'Fonio', description: 'Fonio traditionnel d\'Afrique de l\'Ouest', unit: 'kg', price: 3.50, imageUrl: '' },
      { name: 'Avoine', description: 'Avoine importee de qualite', unit: 'kg', price: 4.20, imageUrl: '' },
      { name: 'Orge', description: 'Orge pour la biere locale', unit: 'kg', price: 3.80, imageUrl: '' },
      { name: 'Ble Dur', description: 'Ble dur pour la fabrication de pates', unit: 'kg', price: 3.20, imageUrl: '' },
      { name: 'Quinoa', description: 'Quinoa bio importee', unit: 'kg', price: 8.50, imageUrl: '' },
      { name: 'Sarrasin', description: 'Sarrasin sans gluten', unit: 'kg', price: 6.80, imageUrl: '' },
      { name: 'Amarante', description: 'Amarante riche en proteines', unit: 'kg', price: 5.50, imageUrl: '' },
      { name: 'Teff', description: 'Teff ethiopien traditionnel', unit: 'kg', price: 7.20, imageUrl: '' },
      { name: 'Epeautre', description: 'Epeautre ancien et nutritif', unit: 'kg', price: 4.80, imageUrl: '' },
      { name: 'Seigle', description: 'Seigle pour pain traditionnel', unit: 'kg', price: 3.60, imageUrl: '' }
    ];
